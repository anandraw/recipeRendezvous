...
public class GobalException {
	...
	public ResponseEntity<ErrorDetails> PostExceptionHandler(RecipeException ue, WebRequest req){
	...
	public ResponseEntity<ErrorDetails> MealExceptionHandler(MealException ue, WebRequest req)
	{
		ErrorDetails err= new ErrorDetails(ue.getMessage(),
				req.getDescription(false),LocalDateTime.now());
